...
const INITIAL_STATE = {
    ...
    // Parametros utilizados para filtrar a lista de onibus em alerta
    filter_params: {},

    // Lista que contém os onibus em alerta filtrados
    filter_items: [],

    // carregar empresas associadas ao funcionario
    array_garagem: [],
...
const OnibusEmAlertaReducer = (state = INITIAL_STATE, action) => {
  switch (action.type) {
    case 'UPDATE_ONIBUS_EM_ALERTA':{
    ...
    case 'FILTER_PARAM_ONIBUS_EM_ALERTA': {
    ...
    case 'DEL_FILTER_PARAM_ONIBUS_EM_ALERTA': {
...
export default OnibusEmAlertaReducer;